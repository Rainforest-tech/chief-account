  ...
  <CRow>
      ...
      <CWidgetStatsA class="mb-4" color="primary">
        ...
        <template #action>
          <CDropdown placement="bottom-end">
            ...
            <CDropdownMenu>
              <CDropdownItem href="#">Действие</CDropdownItem>
              <CDropdownItem href="#">Еще действие</CDropdownItem>
            </CDropdownMenu>
          </CDropdown>
        </template>
        <template #chart>
    ...
    <CCol :xs="3">
      <CWidgetStatsA class="mb-4" color="info">
        ...
        <template #title>Проценты</template>
        <template #action>
          <CDropdown placement="bottom-end">
            <CDropdownToggle
              color="transparent"
